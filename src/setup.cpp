...
Object Assets::enemy({ 400.f, 300.f }, 2.f, Object::Type::ENEMY);
...
void setup() {
	...
	Assets::enemy.getSprite().setTextureRect(sf::IntRect(0, 0, 32, 32));

	Assets::enemy.setSpriteSheet("resources/ghosts.png");
	Assets::enemy.getSprite().setTexture(Assets::enemy.getSpriteSheet());
	Assets::enemy.getSprite().setTextureRect(sf::IntRect(0, 0, 16, 16));
